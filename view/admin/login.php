...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo SITEURL?>/resources/plugins/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="<?php echo SITEURL?>/resources/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
