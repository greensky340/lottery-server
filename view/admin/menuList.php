          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                foreach($data["menuList"] as $arr){
                ?>
                <tr>
                  <td><?php echo $arr["id"]?></td>
                  <td><?php echo $arr["order"]?></td>
                  <td><?php echo $arr["title"]?></td>
                  <td><?php echo $arr["uri"]?></td>
                  <td><?php echo $arr["icon"]?></td>
                  <td>                    
                    <a href="#" operate="edit" id='<?php echo $arr["id"]?>'>编辑</a>/
                    <a href="#" operate="del" id='<?php echo $arr["id"]?>'>删除</a>
                  </td>
                </tr>
                <?php
                }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="tongguo" activeId="987" value="123">通过</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<!-- /.modal -->
<div class="modal fade bs-example-modal-sm" id="edit" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog">
    <div class="modal-content">
      <!-- Horizontal Form -->
          ...
          <div class="form-horizontal">
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="order" placeholder="排序">
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">菜单</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="menu" placeholder="菜单">
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">路径</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="url" placeholder="路径">
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="box-footer">
              <button type="submit" operate="cancleEdit" class="btn btn-default">取消</button>
              <button type="submit" operate="cancleOk" class="btn btn-info pull-right">确认</button>
            </div>
            <!-- /.box-footer -->
          </div>
        </div>
...
<script>
  $(function () {
    ...
    $("[operate='edit']").click(function(options){
      $('#edit').modal('show')
      $('#tongguo').attr('activeId',this.id)
      console.log('edit',options)
    })
    $("[operate='del']").click(function(options){
      $('#modal-default').modal('show')
      $('#tongguo').attr('activeId',this.id)
      console.log('del',options)
    })
    $("[operate='cancleEdit']").click(function(options){
      $("#edit").modal("hide")
    })
  })
</script>
