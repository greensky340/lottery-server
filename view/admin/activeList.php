          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                foreach($activeList as $arr){
                ?>
                <tr>
                  <td><?php echo $arr["active_title"]?></td>
                  <td><?php echo $arr["action_time"]?></td>
                  <td><?php echo $arr["openid"]?></td>
                  <td><?php echo $arr["location"]?></td>
                  <td><?php echo $arr["status"]?></td>
                  <td>
                    <a href="/Admin/getActiveInfo/<?php echo $arr["id"]?>">查看</a>/
                    <a href="#" class="shen" id='<?php echo $arr["id"]?>'>审核</a>
                </td>
                </tr>
                <?php
                }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">确定要审核通过?</h4>
      </div>
